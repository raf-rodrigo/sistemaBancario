...
class Cliente:
    def __init__(self, endereco):
        ...
        self.contas = [] #inia-se com vazio

    def realizar_trasacao(self, conta, transacao):
        transacao.reistrar(conta)
...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\n@@@ Opeação falhou! Você não tem saldo sufucuente. @@@")
        elif valor > 0:
            self._saldo -= valor
...
def recuperar_conta_cliente(cliente):
    ...
    #FIXME: nnão permite cliente escolher a conta
...
def criar_cliente(clientes):
    ...
    endereco = input("Informe o enereço (logradouro, nro - bairro - cidade/sigla estado): ")
